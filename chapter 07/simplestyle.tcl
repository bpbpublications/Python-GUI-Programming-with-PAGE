...
#  Dec 15, 2022 12:42:10 PM CST  platform: Linux
set vTcl(timestamp) ""
...
proc vTclWindow.top1 {base} {
    ...
    wm geometry $top 600x230+1076+594
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
...
### SPOT dump_widget_opt A
    ...
    button "$top.but48" \
        ...
        -command "on_btnMyStyle" -compound left -font "TkDefaultFont" \
        -foreground $vTcl(actual_gui_fg) -highlightcolor black \
        -text "My Style" 
    vTcl:DefineAlias "$top.but48" "btnMyStyle" vTcl:WidgetProc "Toplevel1" 1
### SPOT dump_widget_opt A
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.tBu47 \
        -in $top -x 110 -y 80 -width 183 -relwidth 0 -height 48 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.but48 \
        -in $top -x 320 -y 90 -width 173 -relwidth 0 -height 33 -relheight 0 \
        -anchor nw -bordermode ignore 
