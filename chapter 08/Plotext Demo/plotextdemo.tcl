...
#  Dec 22, 2022 04:37:00 AM CST  platform: Linux
set vTcl(timestamp) ""
...
proc vTclWindow.top1 {base} {
    ...
    wm geometry $top 843x705+769+399
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
...
### SPOT dump_widget_opt A
    ...
    ttk::combobox "$top.tCo48" \
        -font "TkTextFont" -textvariable "comboMarker" -foreground {} \
        -background {} -takefocus {} 
    vTcl:DefineAlias "$top.tCo48" "TCombobox1" vTcl:WidgetProc "Main" 1
### SPOT dump_widget_opt A
    ttk::style configure TCombobox -background $vTcl(actual_gui_bg)
    ttk::style configure TCombobox -foreground $vTcl(actual_gui_fg)
    ttk::style configure TCombobox -font "$vTcl(actual_gui_font_dft_desc)"
    ttk::combobox "$top.tCo49" \
        -font "TkTextFont" -textvariable "comboPlotType" -foreground {} \
        -background {} -takefocus {} 
    vTcl:DefineAlias "$top.tCo49" "TCombobox2" vTcl:WidgetProc "Main" 1
### SPOT dump_widget_opt A
    ...
    label "$top.lab50" \
        -activeforeground #000000 -anchor w -background springgreen3 \
        -compound left \
        -font "-family {DejaVu Sans} -size 10 -weight bold -slant roman -underline 0 -overstrike 0" \
        -foreground $vTcl(actual_gui_fg) -text "Marker Type" 
    vTcl:DefineAlias "$top.lab50" "Label1" vTcl:WidgetProc "Main" 1
### SPOT dump_widget_opt A
    ttk::style configure Label -background $vTcl(actual_gui_bg)
    ttk::style configure Label -foreground $vTcl(actual_gui_fg)
    ttk::style configure Label -font "$vTcl(actual_gui_font_dft_desc)"
    label "$top.lab51" \
        ...
        -compound left \
        -font "-family {DejaVu Sans} -size 10 -weight bold -slant roman -underline 0 -overstrike 0" \
        -foreground $vTcl(actual_gui_fg) -text "Plot type" 
    vTcl:DefineAlias "$top.lab51" "Label2" vTcl:WidgetProc "Main" 1
### SPOT dump_widget_opt A
    ttk::style configure Label -background $vTcl(actual_gui_bg)
    ttk::style configure Label -foreground $vTcl(actual_gui_fg)
    ttk::style configure Label -font "$vTcl(actual_gui_font_dft_desc)"
    label "$top.lab52" \
        -activeforeground #000000 -anchor w -background seagreen3 \
        -borderwidth 3 -compound left \
        ...
        -textvariable "PlotData" 
    vTcl:DefineAlias "$top.lab52" "Label3" vTcl:WidgetProc "Main" 1
### SPOT dump_widget_opt A
    set PlotData {Label}
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.but47 \
        -in $top -x 710 -y 20 -width 93 -relwidth 0 -height 33 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.tCo48 \
        -in $top -x 30 -y 80 -anchor nw -bordermode ignore 
    place $top.tCo49 \
        -in $top -x 260 -y 80 -anchor nw -bordermode ignore 
    place $top.lab50 \
        -in $top -x 40 -y 50 -width 139 -relwidth 0 -height 21 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.lab51 \
        -in $top -x 260 -y 50 -width 149 -relwidth 0 -height 21 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.lab52 \
        -in $top -x 10 -y 130 -width 819 -relwidth 0 -height 561 -relheight 0 \
        -anchor nw -bordermode ignore 
